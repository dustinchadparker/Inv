...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar express = __webpack_require__(/*! express */ \"express\");\r\nvar store_1 = __webpack_require__(/*! ./store */ \"./src/server/routes/api/store.ts\");\r\nvar router = express.Router();\r\nrouter.use('/inventory', store_1.default);\r\nexports.default = router;\r\n\n\n//# sourceURL=webpack:///./src/server/routes/api/index.ts?");

/***/ }),

/***/ "./src/server/routes/api/store.ts":
/*!****************************************!*\
  !*** ./src/server/routes/api/store.ts ***!
  \****************************************/
/*! no static exports found */
...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar express = __webpack_require__(/*! express */ \"express\");\r\nvar Inventory = __webpack_require__(/*! ../../inventoryStore */ \"./src/server/inventoryStore.js\");\r\nvar router = express.Router();\r\nrouter.get('/:id?', function (req, res, next) {\r\n    var id = req.params.id;\r\n    if (id) {\r\n        res.send(Inventory.GetChirp(id));\r\n    }\r\n    else {\r\n        res.send(Inventory.GetInventory());\r\n    }\r\n});\r\nexports.default = router;\r\n\n\n//# sourceURL=webpack:///./src/server/routes/api/store.ts?");
